...
# --- Configuration ---
DATABASE_URL = "postgresql://postgres.stnxjphrwhbwhxkggtvs:Rv%4096216@aws-0-ap-south-1.pooler.supabase.com:5432/postgres"
...
engine = create_engine(
    ...
    connect_args={
        "connect_timeout": 5,
        "options": "-c statement_timeout=5000"  # 🔑 kill hung queries
    }
)
